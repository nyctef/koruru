#include "cAudioFileState.h"

double get_master_clock() { return av_gettime() / 1000000.0; }
 ...
 */ 
int cAudioFileState::synchronize_audio(int samples_size, double pts) {
 ...
 */
int cAudioFileState::audio_decode_frame(double *pts_ptr) {
...
int decode_thread(void *arg) {
	...
	cAudioFileState* is = (cAudioFileState *)arg;
...
cAudioFileState::cAudioFileState(const char* nfilename) {
 ...
 */
double cAudioFileState::get_audio_clock() {
    double pts;
